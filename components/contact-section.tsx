...
import { Mail, MapPin, Phone, Send, Github, Linkedin, ArrowRight } from "lucide-react"
...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="py-24 px-4 bg-secondary/20 relative overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div>
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 backdrop-blur-md mb-8 shadow-[0_0_15px_rgba(var(--primary),0.1)]">
              ...
              <span className="text-primary text-sm font-bold tracking-wide uppercase">Actively Exploring Roles</span>
            </div>
            
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-foreground mb-6 leading-[1.1] tracking-tight text-balance">
              Let&apos;s build the <br /> 
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-indigo-400">future together.</span>
            </h2>
            
            <p className="text-lg text-muted-foreground/90 leading-relaxed mb-10 max-w-md">
              Whether you have a role available, a project idea, or just want to chat about engineering—my inbox is always open. I reply within 24 hours.
            </p>

            <div className="space-y-6 mb-12">
              <Link href="mailto:abhinav01.ak@gmail.com" className="flex items-center gap-4 group w-fit">
                <div className="w-14 h-14 rounded-2xl bg-card border border-border/50 flex items-center justify-center group-hover:border-primary/50 group-hover:bg-primary/5 transition-all duration-300 shadow-sm">
                  <Mail className="text-muted-foreground group-hover:text-primary transition-colors" size={24} />
                </div>
                <div>
                  <p className="text-sm font-semibold text-muted-foreground tracking-wide uppercase">Email</p>
                  <p className="text-foreground text-lg group-hover:text-primary transition-colors font-medium">abhinav01.ak@gmail.com</p>
                </div>
              </Link>
              ...
              <div className="flex items-center gap-4 w-fit">
                ...
                <div>
                  ...
                  <p className="text-foreground text-lg font-medium">Greater Noida, India</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-card/80 backdrop-blur-xl border border-border/50 rounded-[2.5rem] p-8 md:p-10 shadow-2xl">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <label htmlFor="name" className="text-sm font-bold text-muted-foreground uppercase tracking-wider ml-1">
                    Your Name
                  </label>
                  <Input
                    id="name"
                ...
                <div className="space-y-2">
                  <label htmlFor="email" className="text-sm font-bold text-muted-foreground uppercase tracking-wider ml-1">
                    Your Email
                  </label>
                  <Input
                    id="email"
                ...
                <div className="space-y-2">
                  <label htmlFor="message" className="text-sm font-bold text-muted-foreground uppercase tracking-wider ml-1">
                    Your Message
                  </label>
                  <Textarea
                    id="message"
                ...
                <Button 
                  ...
                  className="w-full h-14 rounded-2xl text-base font-bold group relative overflow-hidden bg-primary text-primary-foreground border-none shadow-[0_0_20px_-5px_var(--primary)] hover:shadow-[0_0_30px_-5px_var(--primary)] transition-all duration-300 mt-2"
                >
